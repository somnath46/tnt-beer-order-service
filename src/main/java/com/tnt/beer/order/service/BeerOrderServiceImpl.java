...
import com.tnt.beer.order.repository.BeerOrderRepository;
import com.tnt.beer.order.repository.CustomerRepository;
import com.tnt.beer.order.service.mapper.BeerOrderMapper;
...
public class BeerOrderServiceImpl implements BeerOrderService {
    ...
    public BeerOrderDto placeOrder(UUID customerId, BeerOrderDto beerOrderDto) {
        ...
        if (customerOptional.isPresent()) {
            BeerOrder beerOrder = beerOrderMapper.fromDto(beerOrderDto);
